...
import com.example.softwaredip.commons.Comunicazione;
...
public class ComunRicevWinInterfaccia {
    ...
    @FXML
    private void apriNuovaRichiesta() throws IOException {
        ComunicazioneCtrl.mostraNuovaRichiesta();
    }

    @FXML
    private void apriRichiesteInviate() throws IOException {
        ComunicazioneCtrl.mostraRichiesteInviate();
    }
}
