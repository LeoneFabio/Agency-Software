...
import com.example.softwaredip.gestioneaccount.MenuWinInterfaccia;
import com.example.softwaredip.controls.*;
...
public class Utils {
    ...
    private static int selezionaPaginaMenu(String path){
        ...
        if(path.equals("gestioneaccount/HomeWin.fxml")){
            value = 0;
        } else if(path.equals("gestionestipendi/StipendioWin.fxml")){
            value = 1;
        } else if(path.equals("gestioneturni/TurniWin.fxml")){
            value = 2;
        }else if(path.equals("gestionefirma/FirmaRemotoWin.fxml")){
            value = 3;
